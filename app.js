...
/* -------------------------------------------------------------------------------------------------------------------- */
/* -------------------------------------------------------------------------------------------------------- dialogs --- */
  dialog:function(key){f$.db.getone(key,function(d){var dlg=gid('DLG'+d.$key);if(dlg){dlg.parentElement.removeChild(dlg)}console.log('ok');
		 if(d.$key.indexOf('tag-')==0){
			...
			else if(d.$key.indexOf('metapp-')==0){console.log('ok2');
