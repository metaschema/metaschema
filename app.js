...
/* -------------------------------------------------------------------------------------------------------- results --- */
	...
	_records_reset:function(){this._curr_cols={"$key":{idx:0}};this._curr_cols_count=1;gid('resultsview').innerHTML='<table id="resultstable"><tbody><th>key</th><th>doctitle</th><th>collection</th><th>parent</th><th>tags</th><th>rels</th></tbody><tbody></tbody></table>'},
 _record_odd:false,
